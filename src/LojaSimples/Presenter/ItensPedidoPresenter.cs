...
namespace LojaSimples.Presenter
{
    public class ItensPedidoPresenter : IItemPedidoOutputPort
    {
        /// <summary>
        ...
        public void Success(ItemPedidoOutput output) => this.ViewModel = new OkObjectResult(output);
